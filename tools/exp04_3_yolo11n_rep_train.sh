...
RUN_NAME="exp04_3_yolo11n_rep_e100_${TIMESTAMP}"
...
echo "============================================================"
echo " Exp04.3 YOLO11n-Rep 100-Epoch Formal Training"
echo "============================================================"
echo "run_name=$RUN_NAME"
echo "report_dir=$REPORT_DIR"
echo "pretrained=$PRETRAINED"
...
echo
echo "exp04_3_command_completed=YES"
