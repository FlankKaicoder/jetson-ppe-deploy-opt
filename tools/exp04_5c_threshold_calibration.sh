...
OUTPUT_DIR="$REPO_DIR/results/evaluation/exp04_5c_threshold_calibration_${TIMESTAMP}"
...
echo "============================================================"
echo " Exp04.5c Validation-Calibrated Confidence Threshold Analysis"
echo "============================================================"
echo "output_dir=$OUTPUT_DIR"
echo "baseline_weights=$BASELINE_WEIGHTS"
echo "rep_deploy_weights=$REP_DEPLOY_WEIGHTS"
...

{
    ...
    echo "threshold_sweep=$OUTPUT_DIR/threshold_sweep.csv"
    echo "selected_points=$OUTPUT_DIR/selected_operating_points.csv"
...
echo
echo "exp04_5c_command_completed=YES"
