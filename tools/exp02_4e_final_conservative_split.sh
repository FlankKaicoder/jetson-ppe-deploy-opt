...
DATASET_OUT="/root/autodl-tmp/datasets/derived/construction_ppe3_final_split_v1_${TIMESTAMP}"

REPORT_OUT="$REPO_DIR/results/dataset_audit/exp02_4e_final_split_${TIMESTAMP}"
...
echo "============================================================"
echo " Exp02.4e: Final Conservative Dataset Split"
echo "============================================================"
...
python -m py_compile \
    tools/exp02_4e_final_conservative_split.py
...
PYTHONUNBUFFERED=1 \
python tools/exp02_4e_final_conservative_split.py \
...
if [ "$RC" -eq 0 ]; then
    echo "exp02_4e_command_completed=YES"
else
    echo "exp02_4e_command_completed=NO"
fi
