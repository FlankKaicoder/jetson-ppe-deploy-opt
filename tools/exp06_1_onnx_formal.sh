...
run_name="exp06_1_onnx_formal_${timestamp}"
...
{
    echo "experiment=Exp06.1 ONNX formal consistency"
...

{
    ...
    echo "--run-kind formal --full-eval --imgsz 640 --batch 1 --opset 17"
    echo "--weights $weights"
    echo "--data $data_yaml"
...
echo "============================================================"
echo " Exp06.1 ONNX Formal Consistency"
echo "============================================================"
echo "report_dir=$report_dir"
echo "artifact_dir=$artifact_dir"
...
grep -nE \
    'Traceback|FATAL:|result=FAIL|raw_tensor_result=FAIL|detection_result=FAIL|full_evaluation_result=FAIL' \
...

{
    ...
    echo "evaluation_metrics=$report_dir/evaluation_metrics.csv"
} | tee "$runner_summary"
