...
# v2:
# 感知哈希不再参与 Union-Find 分组，避免相似关系的
# 传递闭包将大量不同场景错误合并。
GLOBAL_DHASH_THRESHOLD = -1
BOUNDARY_DHASH_THRESHOLD = -1
BOUNDARY_NUMERIC_DISTANCE = 0

# dHash 只在完成划分后用于生成跨划分复核候选。
...
def main() -> None:
    ...
    print(
        " Exp02.4b-v2 Conservative Group Split Summary"
    )
    print(
        "============================================================"
    )
    ...
    print(
        "exp02_4b_v2_command_completed=YES"
    )
