...
OUTPUT_DIR="$REPO_DIR/results/evaluation/exp04_5b_reparam_error_size_audit_${TIMESTAMP}"
...
echo "============================================================"
echo " Exp04.5b Reparameterization Error and Size Audit"
echo "============================================================"
echo "output_dir=$OUTPUT_DIR"
echo "baseline_weights=$BASELINE_WEIGHTS"
echo "rep_deploy_weights=$REP_DEPLOY_WEIGHTS"
...

{
    ...
    echo "per_size_metrics=$OUTPUT_DIR/per_size_metrics.csv"
    echo "baseline_per_image=$OUTPUT_DIR/baseline_per_image.csv"
    echo "rep_deploy_per_image=$OUTPUT_DIR/rep_deploy_per_image.csv"
...
echo
echo "exp04_5b_command_completed=YES"
